    ...
    public class publicacionesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.publicaciones != null ? 
                          ...
                          Problem("Entity set 'blog_DbContext.publicaciones'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("publicacionesId,titulo,descripcion,usuarioId")] publicaciones publicaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("publicacionesId,titulo,descripcion,usuarioId")] publicaciones publicaciones)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blog_DbContext.publicaciones'  is null.");
            }
            var publicaciones = await _context.publicaciones.FindAsync(id);
            if (publicaciones != null)
            {
